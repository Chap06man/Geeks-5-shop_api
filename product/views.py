...
class DetailCategoryApiViews(RetrieveUpdateDestroyAPIView):
    queryset = Category.objects.all()
    serializer_class = CatySeriaDetail
    lookup_field = 'id'
...
class ListReviewstApiViews(ListCreateAPIView):
    ...
    serializer_class = ReviewSeriaDetail

class DetailReviewstApiViews(RetrieveUpdateDestroyAPIView):
    queryset = Review.objects.all()
    serializer_class = ReviewSeriaList
    lookup_field = 'id'
#<---------------------------------------------------------------------------------------------->
